...
const Navbar = ({ setCurrentPage }) => {
  ...
  return (
    <div className="navbar bg-base-300 sticky top-0 z-50 shadow-md px-2 sm:px-4 min-h-16">
      <Analytics />
      ...
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul
            ...
            <li><a onClick={() => setCurrentPage('template1')}>template1</a></li>
            <li><a onClick={() => setCurrentPage('template2')}>template2</a></li>
          </ul>
        </div>
      </div>
      ...
      <div className="navbar-center">
        <button 
          className="btn btn-ghost text-lg sm:text-xl normal-case font-bold"
        ...
        {currentUser ? (
          ...
          <div className="dropdown dropdown-end">
            ...
            <ul
              tabIndex={0}
              className="menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-52 p-2 shadow">
              <li className="text-center py-1 text-xs sm:text-sm opacity-70">
